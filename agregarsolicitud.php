            ...
            <form class="signup-form" method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              ...
              <div class="input-field">
                ...
                <select id="cmbValijas" name="cmbValijas">
                  <option value="0">Seleccione # de Valija</option>
                  <?php
              ...
              <div class="input-field">
                ...
                <input id="fecha_solicitud_del" type="text" name="fecha_solicitud_del" type="date" class="datepicker picker__input" value="<?php if ( !empty( $fecha_solicitud_del ) ) echo $fecha_solicitud_del; ?>"/>
                <label for="fecha_solicitud_del" class="active">Fecha solicitud:</label>
              </div>
              ...
              <div class="section">
                <div class="input-field">
                  ...
                  <label>Subdelegación IMSS</label>
                </div>
              </div>
              ...
              <div class="input-field">
                ...
                <?php
                  if ( !empty( $primer_apellido ) ) {
                    echo '<input type="text" class="active validate" name="primer_apellido" id="primer_apellido" length="32" value="' . $primer_apellido . '"/>';
                  } else {
                    echo '<input type="text" class="active validate" name="primer_apellido" id="primer_apellido" length="32"/>';
                  }
                ?>
              ...
              <div class="input-field">
                ...
                <label data-error="Demasiados caracteres" for="segundo_apellido">Segundo apellido</label>
              </div>

              <div class="input-field">
                <i class="material-icons prefix">work</i>
                <input type="text" name="nombre" required class="active validate" id="nombre" length="32" value="<?php if ( !empty( $nombre ) ) echo $nombre; ?>"/>
                <label data-error="Demasiados caracteres" for="nombre">Nombre</label>
              </div>

              <div class="input-field">
                <i class="material-icons prefix">work</i>
                <input type="text" class="validate" name="matricula" id="matricula" length="32" value='<?php if ( !empty( $matricula ) ) echo $matricula; ?>'/>
                <label data-error="Demasiados caracteres" for="matricula">Matrícula</label>
              </div>

              <div class="input-field">
                <div class="section">
                  <i class="material-icons prefix">account_circle</i>
                  <input placeholder="CURP" type="text" length="18" name="curp" value="<?php if ( !empty( $curp ) ) echo $curp; ?>" />
                </div>
              </div>

              <div class="input-field">
                <i class="material-icons prefix">work</i>
                <input type="text" class="validate" name="usuario" id="usuario" length="7" value="<?php if ( !empty( $usuario ) ) echo $usuario; ?>" />
                <label data-error="Demasiados caracteres" for="usuario">Usuario</label>
              </div>
          ...
          <div class="row">
            ...
            if ( isset( $_POST['submit'] ) ) {
              ...
              if ( !preg_match( '/^[0-9]{9}$/', $fecha_solicitud_del ) ) {
                //'dd/mm/yyyy'
                $anio = substr( $fecha_solicitud_del, 7, 4 );
                $mes  = substr( $fecha_solicitud_del, 4, 2 );
                $dia  = substr( $fecha_solicitud_del, 0, 2 );
